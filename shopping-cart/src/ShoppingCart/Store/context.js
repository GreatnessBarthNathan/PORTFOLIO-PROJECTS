...
function AppProvider ({children}){
  // CART
    ...
    function addToCart(id, category, image, price, title) {
      dispatch({type: 'ADD_TO_CART', payload: {id, category, image, price, title}})
    }
  ...
  .catch((error) => {
    ...
    const value = {state, category, page, items, filterItems, addToCart, increment, decrement, getTotals, clearCart, remove, currentUser, person, changeInput, createAccount, signIn, resetPassword, logout}
