       ...
       return (
        <section className="auth-wrapper">
             ...
             <form>
                ...
                <input type="password" name='password' required placeholder='please enter your password' value={person.password} onChange={changeInput}/>
                <label htmlFor="confirm">Confirm Password</label>
                <input type="password" name='confirm' required placeholder='confirm password' value={person.confirm} onChange={changeInput}/>
                <button className='create-account' onClick={createAccount}>Create Account</button>
             </form>
             <p>Already have an account? <Link to='/sign-in'>Sign In</Link></p>
             <p  className= 'redirect'><Link to='/'>Back To Store</Link></p>
        </section>
